...
```{r}
table(accuracy_long$veracity, accuracy_long$accuracy)/rowSums(table(accuracy_long$veracity, accuracy_long$accuracy))
```
...
```{r}
table(accuracy_long$content, accuracy_long$accuracy)/rowSums(table(accuracy_long$content, accuracy_long$accuracy))
```
...
```{r}
table(accuracy_long$veracity, accuracy_long$accuracy, accuracy_long$content) / length(unique(accuracy_long$id))
```
